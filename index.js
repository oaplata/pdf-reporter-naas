...
const generatePDFs = async (payroll, employees) => {
  ...
  const documentSummary = {
    ...
    data: {
      ...
      imssCoutaFijaEmpresa: (payroll.imssCoutaFijaEmpresa || 0).toFixed(2),
      imssCoutaFijaEmpleado: (payroll.imssCoutaFijaEmpleado || 0).toFixed(2),
      imssCesantiaYVejesEmpresa: (payroll.imssCesantiaYVejesEmpresa || 0).toFixed(2),
      imssCesantiaYVejesEmpleado: (payroll.imssCesantiaYVejesEmpleado || 0).toFixed(2),
      imssExcedenteEmpresa: (payroll.imssExcedenteEmpresa || 0).toFixed(2),
      imssExcedenteEmpleado: (payroll.imssExcedenteEmpleado || 0).toFixed(2),
      imssGastosMedicosPensionesEmpresa: (payroll.imssGastosMedicosPensionesEmpresa || 0).toFixed(2),
      imssGastosMedicosPensionesEmpleado: (payroll.imssGastosMedicosPensionesEmpleado || 0).toFixed(2),
      imssGuarderiaEmpresa: (payroll.imssGuarderiaEmpresa || 0).toFixed(2),
      imssGuarderiaEmpleado: (payroll.imssGuarderiaEmpleado || 0).toFixed(2),
      imssInvalidezYVidaEmpresa: (payroll.imssInvalidezYVidaEmpresa || 0).toFixed(2),
      imssInvalidezYVidaEmpleado: (payroll.imssInvalidezYVidaEmpleado || 0).toFixed(2),
      imssPrestacionesEnDineroEmpresa: (payroll.imssPrestacionesEnDineroEmpresa || 0).toFixed(2),
      imssPrestacionesEnDineroEmpleado: (payroll.imssPrestacionesEnDineroEmpleado || 0).toFixed(2),
      imssRTEmpresa: (payroll.imssRTEmpresa || 0).toFixed(2),
      imssRTEmpleado: (payroll.imssRTEmpleado || 0).toFixed(2),
      imssObligacionFondoDeRetiro: (payroll.imssObligacionFondoDeRetiro || 0).toFixed(2),
      imssObligacionImpuestoEstatal: (payroll.imssObligacionImpuestoEstatal || 0).toFixed(2),
      imssObligacionImssEmpresa: (payroll.imssObligacionImssEmpresa || 0).toFixed(2),
      imssObligacionInfonavitEmpresa: (payroll.imssObligacionInfonavitEmpresa || 0).toFixed(2),
      imssObligacionTotal: (payroll.imssObligacionTotal || 0).toFixed(2),
      imssVacations: (payroll.imssVacations || 0).toFixed(2),
      imssVacationsBonus: (payroll.imssVacationsBonus || 0).toFixed(2),
      imssChristmasBonus: (payroll.imssChristmasBonus || 0).toFixed(2),
    },
    type: "buffer",
  };
